...
export const albumsNotStarted: AlbumNotStarted[] = [
  ...
  },
  {
    ...
    progress: 0,
    album: [
      { song: "2 Much", listened: false, rating: 0 },
      { song: "Deserve You", listened: false, rating: 0 },
      { song: "As I Am (feat. Khalid)", listened: false, rating: 0 },
      { song: "Off My Face", listened: false, rating: 0 },
      { song: "Holy (feat. Chance the Rapper)", listened: false, rating: 0 },
      { song: "Unstable (feat. The Kid LAROI)", listened: false, rating: 0 },
      { song: "MLK Interlude", listened: false, rating: 0 },
      { song: "Die For You (feat. Dominic Fike)", listened: false, rating: 0 },
      { song: "Hold On", listened: false, rating: 0 },
      { song: "Somebody", listened: false, rating: 0 },
      { song: "Ghost", listened: false, rating: 0 },
      {
        song: "Peaches (feat. Daniel Caesar & Giveon)",
        listened: false,
        rating: 0,
      },
      { song: "Love You Different (feat. BEAM)", listened: false, rating: 0 },
      { song: "Loved By You (feat. Burna Boy)", listened: false, rating: 0 },
      { song: "Anyone", listened: false, rating: 0 },
      { song: "Lonely (with benny blanco)", listened: false, rating: 0 },
    ],
  },
  {
    id: generateId(),
